...
async function buttonHandler(interaction) {
  ...
  if (confirmed) {
    ...
    console.log(`${interaction.user.username} submitted **Bench:${pending.lifts.Bench}kg**, **Squat:${pending.lifts.Squat}kg**, **Deadlift:${pending.lifts.Deadlift}kg** for the ${pending.gender} ${pending.weightDivision}kg division. (**DOTS: ${dots}**)`);
  } else {
